...
class AsymmetricTernaryQuantizer:
    ...
    def activation_aware_grid_alignment(self, W: torch.Tensor, 
        ...
        Args:
            ...
            X: Calibration activations of shape (B*L, m)
            S: Precomputed covariance matrix X^T X or Hessian block. 
        ...
        # [MODIFIED] Handle Precomputed S (Hessian/Covariance)
        if S is None:
            if X is None:
                raise ValueError("AGA requires either activations X or covariance matrix S")
    ...
    def quantize(self, W: torch.Tensor, 
        ...
        Args:
            ...
            S: Precomputed covariance matrix (optional, replaces X)
        ...
        # [MODIFIED] Check for either X or S
